...
export class CoordinateSystem extends createjs.Container {
    constructor(sizeTop, sizeBottom, sizeLeft, sizeRight, color = createjs.Graphics.getRGB(255, 0, 0), thickness = 1) {
        super();
    ...
    drawCoordinateSystem() {
        ...
        if (this.sizeBootom != 0) {
            ...
            this.addChild(this.arrowLeft);
				        ...
				        if (this.sizeRight!= 0) {
            this.arrowRight = new Arrow(0, 0, this.sizeRight, 0, this.color, 10, 2, 1);
